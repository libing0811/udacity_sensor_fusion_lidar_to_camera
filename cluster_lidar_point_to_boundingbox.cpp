...
void show3DObjects(std::vector<BoundingBox>& boundingBoxes, cv::Size worldSize, cv::Size imageSize, bool bWait){
    ...
    {
        //create random color for current 3D object
        ...
        sprintf(str2, "xmin=%2.2f mm, yw=%2.2f m", xwmin, ywmax-ywmin);
    ...
    // display image
    string windowName = "3D Object From Lidar to Image";
    cv::namedWindow(windowName, 2);
    cv::imshow(windowName, topviewImg);
...
void clusterLidarWithROI(std::vector<BoundingBox> &boundingBoxes, std::vector<LidarPoint> &lidarPoints)
{
    ...
    for (auto it1 = lidarPoints.begin(); it1 != lidarPoints.end(); ++it1)
    {
        ...
        //check how much boundingboxes this lidar point belongs to, if more than 1, this point should not cluster the boundingbox. In order to avoid mis grouping.
